...
//Creo las constantes para pasarles los niveles
const loggerInfo = log4js.getLogger('info')
const loggerWarn = log4js.getLogger('warn')
const loggerError = log4js.getLogger('error')

//Debo exportar cada una de las funciones con sus mensajes. E importarlas en index para usarlas como middleware
